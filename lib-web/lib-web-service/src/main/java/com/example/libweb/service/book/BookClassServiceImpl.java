...
import com.example.libweb.dao.mapper.BookClassMapper;
...
public class BookClassServiceImpl implements BookClassService {
    ...
    public ResultDTO findListByName(String bookClassName) {
         ...
         * 返回查询数据集
         */
        return new ResultDTO(HTTPCode.SCUCESS.getCode(),"查询成功",list);
    }
    ...
    public ResultDTO insert(BookClassDTO bookClassDTO) {
       ...
       if(infullenceNumbers<=0){
        ...
        return new ResultDTO(HTTPCode.SCUCESS.getCode(),"新增成功");
    }
    ...
    public ResultDTO update(BookClassDTO bookClassDTO) {
        ...
        return new ResultDTO(HTTPCode.SCUCESS.getCode(),"更新操作成功");
    }
    ...
    public ResultDTO delete(int bookClassId) {
        ...
        return new ResultDTO(HTTPCode.SCUCESS.getCode(),"删除成功");
    }
    ...
    public ResultDTO findByBookId(int bookClassId) {
        ...
        return new ResultDTO(HTTPCode.SCUCESS.getCode(),"查询成功",bookClassDTO);
    }
}
